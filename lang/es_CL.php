...
$lang2 = array(
	...
	"menu_station_1" => "Videojuegos",
	"menu_station_2" => "ReMixes OverClockeados",
	"menu_station_3" => "Covers", // T.N.: Same for spanish.
	"menu_station_4" => "Chiptunes", // T.N.: "Chiptune" does not have an official translation.
	"menu_station_5" => "Todo",
	...
	"log_503" => "Rainwave experimenta una sobrecarga, intente nuevamente.",
	...
	"log_2001" => "Debes estar sintonizado para poder votar.",
	"log_2002" => "ID de candidato inválida.",
	"log_2003" => "Ya has votado.",
	"log_2004" => "Debes esperar para votar cuando cambias de estación.",
	"log_2005" => "El candidato votado no existe.",
	"log_2006" => "La votación ha finalizado.",
	"log_2007" => "No puedes votar en ésta elección todavía.",
	"log_2008" => "Debes votar en la estación en la cual estás sintonizado.",

	// Making-a-Request Errors
	"log_3000" => "Error del lado del servidor mientras se enviaba el voto. Intente nuevamente.",
	"log_3001" => "Debes acceder para hacer una petición.",
	"log_3002" => "Debes estar sintonizado para hacer una petición.",
	"log_3003" => "Se ha recibido una ID de canción inválida.",
	"log_3004" => "La canción pedida no existe.",
	"log_3005" => "Debes pedir una canción en la estación en la que estás sintonizado.",
	...
	"log_4001" => "Debes acceder para cambiar tus peticiones.",
	...
	"log_6004" => "Esa petición no te pertenece.",
	"log_6005" => "Haz pedido una canción que no existe.",
	"log_6006" => "Debes pedir una canción de la estación a la cual estés sintonizado.",
	"log_6007" => "Ya haz pedido ésa canción.",
	"log_6008" => "Ya haz pedido una canción de ése álbum.",

	// Rating Errors
	"log_7000" => "Error del lado del servidor mientras se enviaba la valoración. Intente nuevamente.",
	"log_7001" => "Debes acceder para poder valorar.",
	"log_7002" => "Debes estar sintonizado para poder valorar.",
	...
	"log_7006" => "Debes haberte sintonizado mientras sonaba la canción para poder valorarla.",
	"log_7007" => "Debes esperar para valorar cuando te cambies de estación.",

	// Request Re-order Errors
	"log_8000" => "Error del lado del servidor mientras se reordenaba. Intente nuevamente.",
	"log_8001" => "Error del lado del cliente mientras se creaba la solicitud para reordenar. Intente nuevamente.",
	"log_8002" => "No tienes peticiones para reordenar.",
	"log_8003" => "Una de tus peticiones se ha cumplido. Intente nuevamente.",
	...
	"overclockedremixes" => "ReMixes OverClockeados", // T.N.: Leaving this, but it sounds... AWFUL!
	...
	"pl_ranks" => "Valoración: |rating| (|S:rank| en el ránking)",
	"pl_favourited" => "Favorito por |count| |P:count,person|.",
	"pl_wins" => "Ha ganado |percent|% de las votaciones.",
	"pl_requested" => "Pedido |count| veces (|S:rank| en el ránking)",
	...
	"notapplicable" => "n/a", // T.N.: Same for spanish.
	"refresh" => "Actualizar",
	...
	"pref_playlist_v_cooldown" => "Tiempo de Enfriamiento",
	...
	"clickonsongtovote_p" => "Luego de sintonizar, haz clic en una canción.|br|La canción más votada sonará a continuación.",
	"tunein" => "Sintonizar",
	...
	"ratecurrentsong_p" => "Mueve el mouse sobre la barra, y haz clic para valorar la canción.|br|Las valoraciones de álbum se promedian de sus valoraciones de canción.",
	...
	"setfavourite_p" => "Haz clic en la caja a la derecha de la barra para marcar o quitar la marca de favorito en una canción o álbum.",
	"playlistsearch_v2" => "Escribe para Buscar",
	"playlistsearch_v2_p" => "La Lista de Canciones se ha seleccionado. Ahora comienza a escribir para buscar.|br|Presiona Escape para limpiar.",
	...
	"openanalbum_p" => "Haz clic en un nombre de álbum en la Lista de Canciones.|br|Los álbumes al final de la lista están en enfriamiento y no pueden ser pedidos.",
	"clicktorequest" => "Hacer una Petición",
	"clicktorequest_p" => "Haz clic en la R para hacer una petición.|br|Las canciones al final de la lista están en enfriamiento y no pueden ser pedidas.",
	"managingrequests" => "Mover Peticiones",
	"managingrequests_p" => "Arrastre para re-ordenar los peticiones, o haga clic en la X para eliminar una petición.",
	"timetorequest" => "Estado de la Petición",
	"timetorequest_p" => "El estado de tu petición se muestra aquí.|br|Si dice \"Expirando\" o \"Enfriando\", es recomendable que selecciones otra canción.",
	"openplaylist" => "Abre la Lista de Canciones",
	"openplaylist_p" => "",

	// What happens when RW crashes
	"crashed" => "Rainwave se ha caído y se ha envuelto en llamas.",
	...
	"conflictswith" => "En conflicto con petición de |requester|.", // T.N.: Present and past use the same word
	"election" => "Votación",
	...
	"loading" => "Cargando",
	"searching" => "Buscando: ",
	"m3uhijack" => "|plugin| está intentando reproducir el M3U. Mejor haz clic derecho y luego 'Guardar como'.",
