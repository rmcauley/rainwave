...
class ListenerStatsBase(api.web.PrettyPrintAPIMixin):
    def get(self):
        ...
        self.write(
            '<script src="//cdnjs.cloudflare.com/ajax/libs/Chart.js/1.0.1/Chart.min.js" type="application/javascript"></script>'
        )
        self.write(
            '<script src="/static/js4_admin/Chart.StackedBar.js" type="application/javascript"></script>'
        )
        self.write("<script>\n")
        ...
        self.write(": ")
        self.write(
            datetime.datetime.fromtimestamp(self.date_start).strftime("%Y-%m-%d %H:%M")
        )
        self.write(" - ")
        self.write(
            datetime.datetime.fromtimestamp(self.date_end).strftime("%Y-%m-%d %H:%M")
        )
        self.write("</h2>")
        ...
        for i in range(
            ...
            self.write(
                ...
                % (
                    "{:0>4d}".format(i),
                    "selected='selected'" if i == dt_start.year else "",
                    i,
                )
            )
        self.write("</select>")
        ...
        for i in range(1, 13):
            self.write(
                ...
                % (
                    "{:0>2d}".format(i),
                    "selected='selected'" if i == dt_start.month else "",
                    i,
                )
            )
        self.write("</select>")
        ...
        for i in range(1, 32):
            self.write(
                ...
                % (
                    "{:0>2d}".format(i),
                    "selected='selected'" if i == dt_start.day else "",
                    i,
                )
            )
        self.write("</select>")
        ...
        for i in range(
            ...
            self.write(
                ...
                % (
                    "{:0>4d}".format(i),
                    "selected='selected'" if i == dt_end.year else "",
                    i,
                )
            )
        self.write("</select>")
        ...
        for i in range(1, 13):
            self.write(
                ...
                % (
                    "{:0>2d}".format(i),
                    "selected='selected'" if i == dt_end.month else "",
                    i,
                )
            )
        self.write("</select>")
        ...
        for i in range(1, 32):
            self.write(
                ...
                % (
                    "{:0>2d}".format(i),
                    "selected='selected'" if i == dt_end.day else "",
                    i,
                )
            )
        ...
        for sid in config.station_ids:
            self.write(
                "<span class='indicator' style='background-color: %s'></span> %s"
                % (station_colors[sid], config.station_id_friendly[sid])
            )
