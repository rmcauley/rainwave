...
class ToolList(api.web.HTMLRequest):
	...
	def get(self):
		...
		for item in [ ("Scan Results", "scan_results"), ("Producers", "producers"), ("Power Hours", "power_hours"), ("DJ Elections", "dj_election"), ("Cooldown", "cooldown"), ("Request Only Songs", "song_request_only"), ("Donations", "donations") ]:
