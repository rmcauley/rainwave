...
user_sheet.resize((65, 780), Image.Resampling.LANCZOS).save(  # type: ignore
    "bright_ldpi.png", optimize=True
)
all_sheet.resize((65, 780), Image.Resampling.LANCZOS).save(  # type: ignore
    "dark_ldpi.png", optimize=True
)
