...
function menu(context: menuContext) {
  ...
  v2.className = style['header unselectable'];
  v1.appendChild(v2);

  const v3 = document.createElement('div');
  v3.className = style['menu-wrapper'];
  v2.appendChild(v3);

  const v4 = document.createElement('ul');
  v4.className = style['menu hamburger-container'];
  v3.appendChild(v4);

  const v5 = document.createElement('li');
  v5.className = style['hamburger-icon-li'];
  v4.appendChild(v5);
  v5.appendChild(hamburgerMenu(context).$root);

  const v6 = document.createElement('a');
  v6.className = style.link;
  v5.appendChild(v6);

  const v7 = document.createElement('div');
  v7.className = style['hamburger-icon'];
  v6.appendChild(v7);

  const v8 = document.createElement('ul');
  v8.className = style['menu user-status'];
  v3.appendChild(v8);
  if (User.id > 1) {
    const v9 = document.createElement('li');
    v9.className = style['user-info'];
    v8.appendChild(v9);
  ...
  v17.className = style['menu main-menu'];
  v3.appendChild(v17);

  const v18 = document.createElement('li');
  v18.className = style['requests-link'];
  v17.appendChild(v18);

  const v19 = document.createElement('div');
  v19.className = style.plusminus;
  v18.appendChild(v19);
  ...
  v21.setAttribute('class', `menu-icon menu-icon-requests`);
  v20.appendChild(v21);
  ...
  v23.className = style['playlist-link'];
  v17.appendChild(v23);
  ...
  v25.setAttribute('class', `menu-icon menu-icon-library`);
  v24.appendChild(v25);
  ...
  v27.className = style['search-link'];
  v17.appendChild(v27);
  ...
  v29.className = style['menu-icon menu-icon-search'];
  ...
  v31.setAttribute('id', `station-select`);
  v31.className = style.closed;
  v3.appendChild(v31);

  const v32 = _svg('pulldown');
  v32.setAttribute('class', `pulldown-arrow`);
  v31.appendChild(v32);

  const v33 = document.createElement('a');
  v33.setAttribute('id', `station-select-header`);
  v33.className = style.station;
  v31.appendChild(v33);

  const v34 = document.createElement('div');
  v34.className = style['station-details'];
  v33.appendChild(v34);

  const v35 = document.createElement('div');
  v35.appendChild(document.createTextNode($l('station_select_header')));
  v35.className = style['station-name'];
  v34.appendChild(v35);
...
return {
  ...
  v46.setAttribute('id', `r4-audio-player`);
  v46.className = style.unselectable;
  v3.appendChild(v46);

  const v47 = document.createElement('div');
  v47.className = style['load-indicator'];
  v46.appendChild(v47);

  const v48 = document.createElement('div');
  v48.className = style['tuned-in-indicator'];
  v46.appendChild(v48);

  const v49 = document.createElement('div');
  v49.className = style['m3u menu-dropdown menu-hover-dropdown pconly'];
  v46.appendChild(v49);

  const v50 = document.createElement('a');
  v50.appendChild(document.createTextNode($l('listen_via_browser')));
  v50.className = style.link;
  v49.appendChild(v50);
  ...
  v53.className = style.background;
  v46.appendChild(v53);

  const v54 = _svg('play');
  v54.setAttribute('class', `audio-icon audio-icon-play`);
  v53.appendChild(v54);

  const v55 = _svg('stop');
  v55.setAttribute('class', `audio-icon audio-icon-stop pconly`);
  v53.appendChild(v55);

  const v56 = _svg('mute');
  v56.setAttribute('class', `audio-icon audio-icon-mute pconly`);
  v53.appendChild(v56);
