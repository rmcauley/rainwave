	...
	*****************************************************************************/
	...
	that.Extend.MenuPanel = function(menup) {
		...
		menup.draw = function() {
			...
			var wmpa = createEl("a", { "href": "/tune_in/" + PRELOADED_SID + ".mp3", "target": "_blank", "class": "tunein_wmp" }, menup.mp3_download);
			createEl("img", { "width": 16, "height": 16, "src": "static/images/blank.png" }, wmpa);
			wmpa.addEventListener("click", menup.tuneInClickMP3, true);
			var itunesa = createEl("a", { "href": "/tune_in/" + PRELOADED_SID + ".mp3", "target": "_blank", "class": "tunein_itunes" }, menup.mp3_download);
			...
			var vlca = createEl("a", { "href": "/tune_in/" + PRELOADED_SID + ".mp3", "target": "_blank", "class": "tunein_vlc" }, menup.mp3_download);
			...
			var winampa = createEl("a", { "href": "/tune_in/" + PRELOADED_SID + ".ogg", "target": "_blank", "class": "tunein_winamp" }, menup.ogg_download);
			...
			var fb2ka = createEl("a", { "href": "/tune_in/" + PRELOADED_SID + ".ogg", "target": "_blank", "class": "tunein_fb2k" }, menup.ogg_download);
