...
request_classes = [
    (r"/api4/?", src.web_api.routes.help.IndexRequest),
    (r"/api4/help/?", src.web_api.routes.help.IndexRequest),
    (r"/api4/help/(.+)", src.web_api.routes.help.HelpRequest),
    (
        r"/static/(.*)",
...
class handle_url:
    ...
    def __call__(self, cls: type[Any]) -> type[Any]:
        ...
        src.web_api.routes.help.add_help_class(cls, cls.url)
