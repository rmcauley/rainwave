...
from common.user.user_model import User, make_user
from common.playlist.song.song import SongNonExistent
...
class RainwaveHandler(tornado.web.RequestHandler):
    ...
    def set_cookie(self, name: str, value: Any, *args: Any, **kwargs: Any) -> None:
        if isinstance(value, int):
            value = repr(value)
        super().set_cookie(name, value, *args, secure=True, samesite="lax", **kwargs)
    ...
    def get_argument_required(
        self, name: str, default: Any = None, **kwargs: Any
    ) -> Any:
    ...
    def get_argument_date_required(
        self, name: str, default: Any = None, **kwargs: Any
    ) -> datetime:
